...
$$
\begin{gathered}
C T c h_{x_{\_} d i m}\left(g e n_{-} 1\right)=\min \left(\operatorname{Prel}\left(\operatorname{gen\_ 1}\right) ; T c h_{x_{\_} d i m}\right) \\
C T c h_{x \_d i m}\left(g e n \_2\right)=\min \left(\text { Prel }\left(g e n_{-} 2\right) ; T c h_{x_{\_} d i m}-C T c h_{x_{\_} d i m}\left(g e n_{-} 1\right)\right)
\end{gathered}
$$
